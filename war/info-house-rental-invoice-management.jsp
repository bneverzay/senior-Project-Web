				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form style="margin: 0cm 12cm 0cm 0cm;" method="post"
							action="save-info-house-rental-invoice-management.jsp?memberID=<%=memberentity.getKeyStringMemberEntity()%>&roomID=<%=roomentity.getKeyStringRoomEntity()%>&lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>">
							...
							<div class="row" style="margin: 2% 0% 0% 51.5%;">
								<a
									href="house-rental-invoice-management.jsp?lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>"><button
