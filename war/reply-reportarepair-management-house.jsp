				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form style="margin: 0cm 12cm 0cm 0cm;" method="post"
							action="save-reply-reportarepair-management-house.jsp?reportarepairID=<%=reportarepairentity.getKeyStringReportarepairEntity()%>&lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>">
							...
							<div class="row" style="margin: 2% 0% 0% 51.5%;">
								<a
									href="reportarepair-management-house.jsp?lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>"><button
