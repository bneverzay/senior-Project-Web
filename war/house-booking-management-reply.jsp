				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form style="margin: 0cm 12cm 0cm 0cm;" method="post"
							action="save-house-booking-management-reply.jsp?lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&rentalID=<%=rentalentity.getKeyStringRentalEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>">
							<div class="form-horizontal">
								<div class="form-group">
									<label class="control-label col-sm-4" for="name">Name:</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="name" name="name"
											placeholder="<%=memberentity.getFirstname()%> <%=memberentity.getLastname()%>"
											disabled="disabled">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="telephone"
											name="telephone"
											placeholder="<%=memberentity.getTelephone()%>"
											disabled="disabled">
									</div>
								</div>
								<%
									if (memberentity.getEmail() == null || memberentity.getEmail() == "") {
								%>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="email"
											name="email" placeholder="<%=memberentity.getEmail()%>"
											disabled="disabled">
									</div>
								</div>
								<%
