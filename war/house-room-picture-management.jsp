...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<h1 class="page-header">
							Management <small>House Picture</small>
						</h1>
						<ol class="breadcrumb">
						...
						<div class="row">
							...
							<div class="col-md-6 portfolio-item">
								<img class="img-responsive"
									...
									<p></p>
								<center><a href="delete-house-room-picture-management.jsp?roomphotoID=<%=checkroomphoto.getKeyStringRoomPhotoEntity()%>&lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>"><button class="btn btn-danger">Delete</button></a></center>
							</div>
							<%
								}
								}
	...
	<form method="post"
		action="<%=blobstoreService.createUploadUrl("/save-house-room-picture-management.jsp")%>"
