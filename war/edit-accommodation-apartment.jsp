				...
				<div class="row">
					<div class="col-lg-12">
						...
						<h1 class="page-header">
							Management <small> Apartment Information</small>
						</h1>
						<ol class="breadcrumb">
						...
						<form style="margin: 0cm 12cm 0cm 0cm;" method="post"
							action="<%=blobstoreService.createUploadUrl("/save-edit-accommodation-apartment.jsp")%>"
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									<div class="col-sm-8" style="margin: 0% 0% 1% 48.1%;">
									...
									<div style="margin-left: 50%;">
										<span class="btn btn-primary btn-file">Upload Picture
											Apartment <input type="file" accept="image/png, image/jpeg"
								...
								<div class="form-group">
									<label class="control-label col-sm-4" for="accommodationname">Apartment
										name:</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="accommodationname"
											name="accommodationname" maxlength="30"
								...
								<div class="form-group">
									<label class="control-label col-sm-4" for="typeofapartment">Type
										of apartment:</label>
									<div class="col-sm-8">
										<select class="form-control" id="typeofapartment"
											name="typeofapartment" style="width: 100%;">
											<%
												String maleapartment = "maleapartment";
												String femaleapartment = "femaleapartment";
												String bothapartment = "bothapartment";
												if (maleapartment.equalsIgnoreCase(accommodationentity.getTypeofapartment())) {
											%>
											<option value="maleapartment" selected>Male
												apartment</option>
											<%
												} else {
											%>
											<option value="maleapartment">Male apartment</option>
											<%
												}
											%>
											<%
												if (femaleapartment.equalsIgnoreCase(accommodationentity.getTypeofapartment())) {
											%>
											<option value="femaleapartment" selected>Female
												apartment</option>
											<%
												} else {
											%>
											<option value="femaleapartment">Female apartment</option>
											<%
												}
											%>
											<%
												if (bothapartment.equalsIgnoreCase(accommodationentity.getTypeofapartment())) {
											%>
											<option value="bothapartment" selected>Both
												apartment</option>
											<%
												} else {
											%>
											<option value="bothapartment">Both apartment</option>
											<%
												}
											%>
										</select>
								...
								<div class="form-group">
									<label class="control-label col-sm-4"
										for="facilitiesinaccommodation">Facilities in
										apartment:</label>
								</div>
								<div class="form-group" style="margin: -3.8% 0% 0% 34.5%;">
									<%
										...
										String drinkingwaterdispenser = "drinkingwaterdispenser";
										String swimmingpool = "swimmingpool";
									...
									<div class="col-sm-20">
										...
										%>
										<%
											if (elevator.equalsIgnoreCase(accommodationentity.getElevator())) {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="elevator" name="elevator" value="elevator" checked>Elevator</label>
										<%
											} else {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="elevator" name="elevator" value="elevator">Elevator</label>
										<%
											}
										%>
									</div>
									<div class="col-sm-20">
										<%
											if (washingmachine.equalsIgnoreCase(accommodationentity.getWashingmachine())) {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="washingmachine" name="washingmachine"
											value="washingmachine" checked>Washing machine</label>
										<%
											} else {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="washingmachine" name="washingmachine"
											value="washingmachine">Washing machine</label>
										<%
											}
										%>
										<%
											if (drinkingwaterdispenser.equalsIgnoreCase(accommodationentity.getDrinkingwaterdispenser())) {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="drinkingwaterdispenser" name="drinkingwaterdispenser"
											value="drinkingwaterdispenser" checked>Drinking water
											dispenser</label>
										<%
											} else {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="drinkingwaterdispenser" name="drinkingwaterdispenser"
											value="drinkingwaterdispenser">Drinking water
											dispenser</label>
										<%
											}
										%>
									...
									<div class="col-sm-20">
										<%
											if (swimmingpool.equalsIgnoreCase(accommodationentity.getSwimmingpool())) {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="swimmingpool" name="swimmingpool" value="swimmingpool"
											checked>Swimming pool</label>
										<%
											} else {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="swimmingpool" name="swimmingpool" value="swimmingpool">Swimming
											pool</label>
										<%
											}
										%>
										<%
											if (fitness.equalsIgnoreCase(accommodationentity.getFitness())) {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="fitness" name="fitness" value="fitness" checked>Fitness</label>
										<%
											} else {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="fitness" name="fitness" value="fitness">Fitness</label>
										<%
											}
										%>
										<%
											if (keycard.equalsIgnoreCase(accommodationentity.getKeycard())) {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="keycard" name="keycard" value="keycard" checked>Keycard</label>
										<%
											} else {
										%>
										<label class="checkbox-inline"><input type="checkbox"
											id="keycard" name="keycard" value="keycard">Keycard</label>
										<%
											}
										%>
									</div>
							...
							<div class="row" style="margin: 2% 0% 0% 51.5%;">
								<a
									href="apartment-dashboard.jsp?lessorID=<%=lessorentity.getKeyStringLessorEntity()%>&accommodationID=<%=accommodationentity.getKeyStringAccommodationEntity()%>"><button
